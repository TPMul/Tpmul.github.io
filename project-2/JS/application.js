           ...
           var projection = d3.geo.equirectangular()
            ...
            .data(ourData)
             ...
             .on("mouseover", function(d) {div.transition()
              				   .duration(200)
              				   .style("opacity", 1)
              				   div .html("<img src='d.avartar_url'></img>"+ d.username + " has drafted " + d.draftees_count + " Draftees." + "<br>" + "has received "+ d.likes_received_count + " likes on their shots." + "<br>" + "And are from " + d.country)
